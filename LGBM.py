...
final_lgbm = LGBMClassifier(**params)

# Train the model on the balanced data
print('Training the final model on balanced data...')
final_lgbm.fit(X_train_balanced, y_train_balanced)
...
# Calculate ROC AUC
y_test_pred_proba = final_lgbm.predict_proba(X_test_scaled)[:, 1]
...
model_filename = 'best_lgbm_model_smote.pkl'
